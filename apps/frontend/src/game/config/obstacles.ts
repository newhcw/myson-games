...
export const obstaclePresets: ObstaclePreset[] = [
  ...
  { type: 'flower', size: [0.5, 0.3, 0.5], pos: [15, 0, -10], color: 0xFF1493, castShadow: false, health: 30 },
  { type: 'flower', size: [0.6, 0.25, 0.6], pos: [-6, 0, 8], color: 0xFFD700, castShadow: false, health: 30 },
