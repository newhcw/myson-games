...
- Name: kids-game-platform/TC0049-scope-magnification.spec.ts >> TC0049 倍镜功能测试 >> TC0049b: 开镜后准星应该切换为精细十字准星
- Location: tests/e2e/kids-game-platform/TC0049-scope-magnification.spec.ts:35:3
...
Locator: locator('.scope-crosshair')
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for locator('.scope-crosshair')
