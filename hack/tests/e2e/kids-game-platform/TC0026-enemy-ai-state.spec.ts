...
test.describe('敌人AI状态机测试', () => {
  ...
  test('TC0032 - 敌人状态机应能正确进入巡逻状态', async ({ page }) => {
    // 等待游戏加载完成
  ...
  test('TC0033 - 敌人状态机应能正确进入追逐状态', async ({ page }) => {
    // 等待游戏加载完成
    await gamePage.expectLoaded();
  ...
  test('TC0034 - 敌人状态机应能正确进入丢失状态', async ({ page }) => {
    // 等待游戏加载完成
    await gamePage.expectLoaded();
  ...
  test('TC0035 - 敌人状态机应能正确在状态间切换', async ({ page }) => {
    // 等待游戏加载完成
    await gamePage.expectLoaded();
